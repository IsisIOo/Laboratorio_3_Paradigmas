...
public class System_21168603_ioyanedelalvarez implements Interfaz_system_21168603_ioyanedel {
    ...
    /**
     * FUNCION 1 TDA system - constructor  Método constructor de un sistema. Deja registro de la fecha de creacion.
    ...
    /**
     * FUNCION 4 LOGIN Metodo que permite iniciar sesion con un usuario del sistema, solo si este existe.
    ...
    public void login(String nombre) {
        ...
        if (currentUsers.contains(nombre) && logueados.isEmpty()) {
            ...
            System.out.println("El usuario ha iniciado sesion correctamente.");
        }
        else{
    ...
    /**
     * FUNCION 5 LOGOUT Método que permite cerrar la sesion de un usuario en el sistema.
     */
     ...
     * El metodo solo debe funcionar cuando hay un usuario con sesion iniciada en el sistema a partir del método de login.
    ...
    /**
     * FUNCION 8 CD Metodo que permite cambiar la ruta (path) donde se realizaran las proximas operaciones. cd permite cambiarse a un directorio especificado a partir de la ruta señalada en un String. Ademas,
     * contara con los comodines especiales  (se usa slash en lugar de backslash) que permitiran referirse a la carpeta actual,
     * regresar a la carpeta del nivel anterior siguiendo la ruta actual del usuario y volver a la raiz de la unidad respectivamente.
...
//caso /.folder1
    ...
    public void addFile(File_21168603_ioyanedelalvarez archivo){
        ...
        if (!currentFiles.contains(archivo.getNombre()) && !logueados.isEmpty() ){
            ...
            System.out.println("ya existe un archivo con ese Titulo, ingrese otro titulo y extension.\n");
    ...
    /**
     * FUNCION 10 DEL Método para eliminar un archivo o varios archivos en base a un patron determinado.
     * Esta version también puede eliminar una carpeta completa con todos sus subdirectorios. El contenido eliminado se va a la papelera.
...
//caso carpeta simple
    ...
    public void copy (String file, String target){
        ...
        if(file.contains(".") && !logueados.isEmpty()){
            ...
            //conseguimos la penultima posicion del registro de ruta
    ...
    /**
     *  FUNCION 11 MOVE Método para mover un archivo o carpeta desde una ruta origen a una ruta destino. La operacion de mover elimina el contenido desde la ruta origen.
